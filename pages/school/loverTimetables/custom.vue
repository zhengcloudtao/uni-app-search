	...
	export default {
		...
		methods: {
			...
			add: function(e) {
				...
				var arr = []
				arr[0] = formdata
				const myCustomTimetable = _this.$store.state.myCustomLoveTimetable
				var timetable = null
				...
				_this.$store.commit('myCustomLoveTimetable', timetable)
				uni.showModal({
					content: "添加成功",
					showCancel: false,
				})
